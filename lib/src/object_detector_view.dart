...
class ObjectDetectorView extends StatefulWidget {
  ObjectDetectorView({super.key, required this.objectLabels});
...
class _ObjectDetectorView extends State<ObjectDetectorView> {
  ...
  void initState() {
    ...
    // print('inital length...........==${detectedObjects.length}');
    speak(
        "Please use your phone,to scan the space around you. Once done, double tap on the screen to see the result");
  ...
  void dispose() {
    ...
    // print('length...........==${detectedObjects}');
    // fn();

    // controller.objectLabels.forEach((label, count) {
    //   print('length.....= $label: $count');
    // });
    print('final length...........==${detectedObjects.length}');
    detectedObjects.clear();
    // controller.update();
    // wid.objectLabels.clear();
    super.dispose();
  }
  ...
  void _initializeDetector() async {
    ...
    if (_option == 0) {
      ...
      print(
          'use custom model path: $modelPath ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,');
