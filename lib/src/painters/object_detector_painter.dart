...
class ObjectDetectorPainter extends CustomPainter {
  ObjectDetectorPainter(this._objects, this.imageSize, this.rotation,
      this.cameraLensDirection, this.detectedObjects, this.objectLabels);
    ...
    for (final DetectedObject detectedObject in _objects) {
      ...
      if (detectedObject.labels.isNotEmpty) {
        ...
        controller.objectLabels
            .update(labelText, (value) => value + 1, ifAbsent: () => 1);
      }
      builder.pop();
